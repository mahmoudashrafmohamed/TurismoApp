...
public class MyProfileActivity extends AppCompatActivity {
    ...
    //views
    TextView name,country,age,mail;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_profile_nav);
        ...
        // views
        name = (TextView)findViewById(R.id.name_txtv);
        pic  = (de.hdodenhof.circleimageview.CircleImageView)findViewById(R.id.imageView);
        country =  (TextView)findViewById(R.id.country);
        age =  (TextView)findViewById(R.id.age);
        mail = (TextView)findViewById(R.id.mail_txtv);
        ...
        if(TYPE.equals("carOwner")){
           ...
           TYPE_temp="tourist";
            ...
            TYPE_temp="tour_guide";
        }
        // send ID to get User Info
         connector = new Connector(this,name,pic,country,age);
         connector.getUserInfo(ID,TYPE_temp);
