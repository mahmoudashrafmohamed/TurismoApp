...
public class TourGuideActivity extends AppCompatActivity {
    ...
    //adapter
    private tourguide_adapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tour_guides_nav);
        ...
        * */
        ...
        if(TYPE_temp.equals("Car Owner")){
            URL = "https://turismo2017.000webhostapp.com/car_owners/";
        }
        else if(TYPE_temp.equals("Tourist")){
            URL = "https://turismo2017.000webhostapp.com/tourists/";
        }
        else{
            URL = "https://turismo2017.000webhostapp.com/tour_guides/";
        }
        con.GetTourGuides(URL);
